...
<xsl:variable name="filename" select="'ritgerd8.correct.txt'"/>
<xsl:variable name="text_encoding" select="'txt'"/>
<xsl:variable name="title" select="'... maðurinn finnur það sem hann leitar að, og sá sem trúir á draug finnur draug.'"/>
