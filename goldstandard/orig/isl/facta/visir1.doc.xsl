...
<xsl:variable name="filename" select="'visir1'"/>
<xsl:variable name="text_encoding" select="'doc'"/>
<xsl:variable name="title" select="'Ísland orðið dýr og síðri kostur fyrir marga'"/>
<xsl:variable name="author1_fn" select="'Breki Logason'"/>
...
<xsl:variable name="mainlang" select="'isl'"/>
